function updateProfileInfo(profileData) {
  ...
  email.href = `mailito:${profileData.email}`;
}
...
function updateEducation(profileData){
    const updateEducation = document.getElementById('profile.education')
    updateEducation.innerHTML = profileData.education.map(education => {
        return `
        <li>
